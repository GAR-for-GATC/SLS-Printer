...
;**************************************************************				
;	The AREA command creates a new data section.
;  CODE means that this area contains machine instructions
;  READONLY means that this section isn't written to.
;**************************************************************
				AREA    |.text|, CODE, READONLY
					
;**************************************************************
;	Creates a function that can be called from C files.  The
; directive EXPORT that the symbol can be used by the linker 
; to resolve references in separte object or library files.
; GLOBAL means the same thing as EXPORT.	   
;**************************************************************
				EXPORT  DisableInterrupts
				EXPORT  EnableInterrupts
					
;****Disable Interrupt Function********************************
; Disable interrupts by setting the PRIMASK register.
; inputs:  none
; outputs: none
;	CPSID is used to set the special purpose register PRIMASK
;	BX is a branch instruction to the LR register, which holds
;	the return information for subroutines, function calls, and
;	exceptions.  All functions in assembler should have a BX LR
;	at the end of it.
;**************************************************************
DisableInterrupts
        CPSID  I
...
; This function Enables interupts by clearing the special-
; purpose register PRIMASK using the directive CPSIE.  
; inputs:  none
; outputs: none
;**************************************************************
EnableInterrupts
...
; This code is used to define the stack and heap.
